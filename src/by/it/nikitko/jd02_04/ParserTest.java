...
public class ParserTest {
   ...
   public void setUp() {
    ...
    @Test
    public void scalarA4() throws CalcException {
    ...
    public void scalarB3() throws CalcException {
    ...
    @Test
    public void matrixC1() throws CalcException {
    ...
    @Test
    public void matrixC2() throws CalcException {
    ...
    @Test
    public void matrixC3() throws CalcException {
        String expression = "{{1,2},{8,3}}+{{1,2},{8,3}}";
        Var actualVar = parser.calc(expression);
    ...
    @Test
    public void scalarCreate() throws CalcException {
    ...
    @Test
    public void vectorCreate() throws CalcException {
    ...
    public void matrixCreate() throws CalcException {
